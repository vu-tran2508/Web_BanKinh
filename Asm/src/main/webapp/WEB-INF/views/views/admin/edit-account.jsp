		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="tab-pane fade show active">
					<form:form action="/manageraccount/checkedit"
						modelAttribute="LISTACCOUNT" method="post">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col">
								...
								<div class="card-footer text-muted">
									...
									<a href="/manageraccount/editaccount" class="btn btn-primary">clear</a>
									<a href="/manageraccount/listaccount/page"
										class="btn btn-primary">Display Customer</a>
								</div>
							</div>
						</div>
					</form:form>
